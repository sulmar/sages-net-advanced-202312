...
internal class TaxCalculator
{
    ...
    public Task<decimal> CalculateAsync(decimal income, CancellationToken cancellationToken = default, IProgress<int> progress = default)
    {
        return Task.Run(() => Calculate(income, cancellationToken, progress));
    }
